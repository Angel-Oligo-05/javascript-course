...
class Workout {
  ...
  constructor(coords, distance, duration) {
    //store the coordinates as an array of longitude and latitude
    this.coords = coords;
  ...
  _setDescription() {
    ...
    //genrate a description using sworkout type and current date
...
class App {
    ...
    _loadDefaultMap() {
        ...
        const coords = [14.5995, 120.9842]; // Manila coordinates
